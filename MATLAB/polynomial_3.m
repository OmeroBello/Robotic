function [p, F] = polynomial_3(T, Q0) %p dà punti che descrivono asse x (tempo), mentre F è vettore di vettori, con evoluzione posizione, velocità, accelerazione, jerk (variazioni di accelerazione). T tempo, Q0 condizioni al contorno
    ...
    NPoints = 1000; %numeri di punti per discretizzare il tutto
